...
let cate2 = [
    ...
    // 調理器具
    ['包丁','まな板','ミキサー','泡立て器','木べら']
];

// 商品の定義
var itemList = [
    { id: '0001', name: 'ソファベッド', tags: ['ベッド', 'ソファ', '寝具'], price: 25000 },
    { id: '0002', name: 'シングルベッド', tags: ['ベッド', 'ソファ', '寝具'], price: 25000 },
    { id: '0003', name: '子ども用ベッド', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'], price:15000 },
    { id: '0004', name: 'ソファ', tags: ['ソファ'], price: 10000 },
    { id: '0005', name: 'キューブボックス', tags: ['家具・ラック', '収納システム'], price: 10000 },
    { id: '0006', name: 'オープンラック', tags: ['家具・ラック', '収納システム'], price: 10000 },
    { id: '0007', name: 'コンピュータデスク', tags: ['テーブル・椅子'], price: 15000 },
    { id: '0008', name: 'サイドテーブル', tags: ['テーブル・椅子'], price: 15000 },
    { id: '0009', name: 'ダイニングテーブル', tags: ['テーブル・椅子'], price: 15000 },
    { id: '0010', name: '子ども部屋用収納', tags: ['収納システム', '子ども部屋家具'], price: 8000 },
    { id: '0011', name: '自動調理器具', tags: ['ミキサー'], price: 2000 },
    { id: '0012', name: '手動調理器具', tags: ['包丁','まな板','泡立て器','木べら'], price: 5000 },
];
